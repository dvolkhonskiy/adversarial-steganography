...
files = dir(fullfile('/', 'home', 'dvolkhonskiy', 'datasets', 'stego_celeb', 'test', '*.png'));
...
for file = files'
    ...
    image = imread(fullfile('/', 'home', 'dvolkhonskiy', 'datasets', 'stego_celeb', 'test', file.name));
    ...
    imwrite(image, strcat('/home/dvolkhonskiy/datasets/stego_celeb/test/stego_', file.name), 'png')
