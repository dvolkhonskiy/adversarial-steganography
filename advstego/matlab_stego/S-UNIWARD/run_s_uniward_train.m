...
files = dir(fullfile('/', 'home', 'dvolkhonskiy', 'datasets', 'stego_celeb', 's_uniward_train', '*.png'));
...
for file = files'
    ...
    image = double(imread(fullfile('/', 'home', 'dvolkhonskiy', 'datasets', 'stego_celeb', 's_uniward_train', file.name)));
    ...
    imwrite(image, strcat('/home/dvolkhonskiy/datasets/stego_celeb/s_uniward_train/stego_', file.name), 'png')
